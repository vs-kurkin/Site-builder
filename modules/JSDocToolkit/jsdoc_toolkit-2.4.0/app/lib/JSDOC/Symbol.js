...
JSDOC.Symbol.prototype.populate = function (/** String */ name, /** Object[] */ params, /** String */ isa, /** JSDOC.DocComment */ comment) {
	this.$args = arguments;
...
JSDOC.Symbol.prototype.setTags = function () {
	...
	if (returns.length) { // there can be many return tags in a single doclet
		...
		this.type = returns.map(
			function ($) {return $.type}).join(", ");
	}
